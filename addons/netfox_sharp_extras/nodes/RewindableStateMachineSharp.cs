...
[Tool]
[GlobalClass]
public partial class RewindableStateMachineSharp : Node
{
    ...
    [Export] RewindableStateSharp CurrentState;
    ...
    [Signal]
    public delegate void OnStateChangedEventHandler(RewindableStateSharp oldState, RewindableStateSharp newState);
    ...
    public delegate void
        OnDisplayStateChangedEventHandler(RewindableStateSharp oldState, RewindableStateSharp newState);

    static NetfoxLogger _logger = NetfoxLogger.ForExtras("RewindableStateMachine");

    RewindableStateSharp _previousStateObject;
    Dictionary<StringName, RewindableStateSharp> _availableStates = new();
    ...
    public void Transition(StringName newStateName)
    {
        ...
        RewindableStateSharp newState = _availableStates[newStateName];
        ...
        RewindableStateSharp oldState = CurrentState;
    ...
    public override void _Notification(int what)
    {
        ...
        {
            foreach (RewindableStateSharp state in GetChildren().OfType<RewindableStateSharp>())
            {
